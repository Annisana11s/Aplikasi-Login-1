...
/**
* Membuat variabel input EmailElement untuk tampilan input email.
* @constant {HTMLElement}
*/
...
loginFormElement.addEventListener('submit', function(event) {
  ...
  /**
  * Membuat variabel email untuk menyimpan nilai email yang didapakatkan saat button ditekan
  * @constant {string}
  */
  const email = inputEmailElement.value;
  
  /**
  * Membuat variabek password untuk menyipan nilai password yang didapatkan
  * @constant {string}
  */
